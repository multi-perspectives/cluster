 ...
 * delegates.
 */
public class CslLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.feature.model.constraint.resource.csl.util.AbstractCslInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.feature.model.constraint.resource.csl.util.AbstractCslInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.feature.model.constraint.resource.csl.debug.CslDebuggableInterpreter<ResultType, ContextType> interpreter = new org.feature.model.constraint.resource.csl.debug.CslDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.feature.model.constraint.resource.csl.debug.CslDebuggerListener<ResultType, ContextType> debugListener = new org.feature.model.constraint.resource.csl.debug.CslDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.feature.model.constraint.resource.csl.debug.CslDebugProcess process = new org.feature.model.constraint.resource.csl.debug.CslDebugProcess(launch);
		launch.addDebugTarget(new org.feature.model.constraint.resource.csl.debug.CslDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.feature.model.constraint.resource.csl.launch.CslLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.feature.model.constraint.resource.csl.util.CslResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.feature.model.constraint.resource.csl.mopp.CslPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
