...
public class CslResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.feature.model.constraint.resource.csl.util.CslInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.feature.model.constraint.resource.csl.util.CslInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.feature.model.constraint.resource.csl.mopp.CslResource getResource(java.io.File file) {
	...
	public static org.feature.model.constraint.resource.csl.mopp.CslResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.feature.model.constraint.resource.csl.mopp.CslResource) resource;
	}
	 ...
	 */
	public static org.feature.model.constraint.Constraint getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.feature.model.constraint.Constraint getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.feature.model.constraint.Constraint) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.feature.model.constraint.Constraint getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.feature.model.constraint.resource.csl.ICslTextResource resource = (org.feature.model.constraint.resource.csl.ICslTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.feature.model.constraint.resource.csl.ICslTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.feature.model.constraint.resource.csl.ICslTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
