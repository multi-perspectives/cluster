...
public class CslResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public CslResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.feature.model.constraint.resource.csl.util.CslRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.feature.model.constraint.resource.csl.util.CslEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.feature.model.constraint.resource.csl.mopp.CslResourceFactory());
		}
	}
