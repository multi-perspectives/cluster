...
public class CslRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.feature.model.constraint.resource.csl.mopp.CslPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.feature.model.constraint.resource.csl.mopp.CslPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
