...
public class CslLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.feature.model.constraint.resource.csl.debug.lineBreakpoint.marker";
	
	public CslLineBreakpoint() {
		super();
	}
	
	public CslLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.feature.model.constraint.resource.csl.debug.CslDebugTarget target) {
		try {
	...
	public void remove(org.feature.model.constraint.resource.csl.debug.CslDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
