 ...
 */
public class CslMinimalModelHelper {
	
	private final static org.feature.model.constraint.resource.csl.util.CslEClassUtil eClassUtil = new org.feature.model.constraint.resource.csl.util.CslEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.feature.model.constraint.resource.csl.util.CslStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.feature.model.constraint.resource.csl.util.CslListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.feature.model.constraint.resource.csl.util.CslStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.feature.model.constraint.resource.csl.util.CslListUtil.castListUnchecked(value);
