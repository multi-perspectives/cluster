 ...
 */
public class CslEnumerationTerminal extends org.feature.model.constraint.resource.csl.grammar.CslTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public CslEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.feature.model.constraint.resource.csl.grammar.CslCardinality cardinality, int mandatoryOccurrencesAfter) {
