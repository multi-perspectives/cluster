 ...
 */
public class CslPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.feature.model.constraint.resource.csl";
	/**
	...
	private static CslPlugin plugin;
	...
	public static CslPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, CslPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, CslPlugin.PLUGIN_ID, message);
		}
		final CslPlugin pluginInstance = CslPlugin.getDefault();
