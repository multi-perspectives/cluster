...
public class CslNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.feature.model.constraint.resource.csl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.feature.model.constraint.resource.csl.mopp.CslBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.feature.model.constraint.resource.csl.mopp.CslBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
