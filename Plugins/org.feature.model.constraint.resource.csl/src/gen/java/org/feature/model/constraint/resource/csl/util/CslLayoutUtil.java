...
public class CslLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.feature.model.constraint.resource.csl.grammar.CslSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.feature.model.constraint.resource.csl.grammar.CslGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.feature.model.constraint.resource.csl.grammar.CslSyntaxElement syntaxElement = org.feature.model.constraint.resource.csl.grammar.CslGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.feature.model.constraint.resource.csl.grammar.CslPlaceholder) {
			org.feature.model.constraint.resource.csl.grammar.CslPlaceholder placeholder = (org.feature.model.constraint.resource.csl.grammar.CslPlaceholder) syntaxElement;
			org.feature.model.constraint.resource.csl.ICslTokenResolver tokenResolver = new org.feature.model.constraint.resource.csl.mopp.CslTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.feature.model.constraint.resource.csl.ICslTokenResolveResult result = new org.feature.model.constraint.resource.csl.mopp.CslTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.feature.model.constraint.resource.csl.mopp.CslLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.feature.model.constraint.resource.csl.mopp.CslLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
