 ...
 */
public class CslDebuggableInterpreter<ResultType, ContextType> extends org.feature.model.constraint.resource.csl.debug.AbstractCslDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.feature.model.constraint.resource.csl.util.AbstractCslInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.feature.model.constraint.resource.csl.ICslCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public CslDebuggableInterpreter(org.feature.model.constraint.resource.csl.util.AbstractCslInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.feature.model.constraint.resource.csl.ICslInterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = org.feature.model.constraint.resource.csl.util.CslStringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public org.feature.model.constraint.resource.csl.util.AbstractCslInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.feature.model.constraint.resource.csl.ICslLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.feature.model.constraint.resource.csl.ICslLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.feature.model.constraint.resource.csl.ICslCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.feature.model.constraint.resource.csl.util.CslEObjectUtil.getDepth(current);
		stopCondition = new org.feature.model.constraint.resource.csl.ICslCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.feature.model.constraint.resource.csl.util.CslEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.feature.model.constraint.resource.csl.util.CslEObjectUtil.getDepth(current) - 1;
		stopCondition = new org.feature.model.constraint.resource.csl.ICslCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
