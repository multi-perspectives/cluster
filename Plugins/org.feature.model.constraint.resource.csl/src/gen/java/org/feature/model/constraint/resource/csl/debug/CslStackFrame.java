...
public class CslStackFrame extends org.feature.model.constraint.resource.csl.debug.CslDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.feature.model.constraint.resource.csl.debug.CslDebugTarget target;
	private String name;
	private int id;
	...
	public CslStackFrame(org.feature.model.constraint.resource.csl.debug.CslDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.feature.model.constraint.resource.csl.util.CslStringUtil.decode(data, ',');
	...
	private org.feature.model.constraint.resource.csl.debug.CslDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.feature.model.constraint.resource.csl.debug.CslStackFrame other = (org.feature.model.constraint.resource.csl.debug.CslStackFrame) obj;
		if (name == null) {
