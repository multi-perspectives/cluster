...
public class CslDebugThread extends org.feature.model.constraint.resource.csl.debug.CslDebugElement implements org.eclipse.debug.core.model.IThread, org.feature.model.constraint.resource.csl.debug.ICslDebugEventListener {
	
	private boolean suspended = false;
	private org.feature.model.constraint.resource.csl.debug.CslDebugTarget debugTarget;
	
	public CslDebugThread(org.feature.model.constraint.resource.csl.debug.CslDebugTarget target) {
		super(target);
	...
	public org.eclipse.debug.core.model.IStackFrame[] getStackFrames() throws org.eclipse.debug.core.DebugException {
		if (isSuspended()) {
			org.feature.model.constraint.resource.csl.debug.CslDebugMessage stack = this.debugTarget.getDebugProxy().getStack();
			String framesData = stack.getArgument(0);
			if (framesData != null && !"".equals(framesData)) {
				java.util.List<String> frames = org.feature.model.constraint.resource.csl.util.CslStringUtil.decode(framesData, '#');
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					theFrames[frames.size() - i - 1] = new org.feature.model.constraint.resource.csl.debug.CslStackFrame(getTarget(), data);
				}
				return theFrames;
			}
		}
	...
	public org.feature.model.constraint.resource.csl.debug.CslDebugTarget getTarget() {
		return debugTarget;
	}
