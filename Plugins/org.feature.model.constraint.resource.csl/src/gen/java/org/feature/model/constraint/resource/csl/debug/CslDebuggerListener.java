 ...
 * code).
 */
public class CslDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.feature.model.constraint.resource.csl.debug.AbstractCslDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.feature.model.constraint.resource.csl.util.CslPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.feature.model.constraint.resource.csl.util.CslPair<String, Object>>();
	...
	public CslDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.feature.model.constraint.resource.csl.debug.CslDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.feature.model.constraint.resource.csl.util.CslStringUtil.encode('#', stack);
				org.feature.model.constraint.resource.csl.debug.CslDebugMessage message = new org.feature.model.constraint.resource.csl.debug.CslDebugMessage(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.feature.model.constraint.resource.csl.debug.CslDebugMessage message = new org.feature.model.constraint.resource.csl.debug.CslDebugMessage(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_VARIABLES)) {
				...
				org.feature.model.constraint.resource.csl.debug.CslDebugMessage message = new org.feature.model.constraint.resource.csl.debug.CslDebugMessage(org.feature.model.constraint.resource.csl.debug.ECslDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.feature.model.constraint.resource.csl.util.CslStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.feature.model.constraint.resource.csl.util.CslPair<String, Object> pair = new org.feature.model.constraint.resource.csl.util.CslPair<String, Object>(name, value);
	...
	public org.feature.model.constraint.resource.csl.debug.AbstractCslDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.feature.model.constraint.resource.csl.debug.AbstractCslDebuggable debuggable) {
