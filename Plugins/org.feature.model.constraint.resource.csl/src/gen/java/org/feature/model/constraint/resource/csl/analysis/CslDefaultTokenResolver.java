 ...
 */
public class CslDefaultTokenResolver implements org.feature.model.constraint.resource.csl.ICslTokenResolver {
	 ...
	 */
	public CslDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public CslDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.feature.model.constraint.resource.csl.ICslTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.feature.model.constraint.resource.csl.grammar.CslGrammarInformationProvider.INSTANCE.getKeywords()) {
