 ...
 * contains
 * <code>org.feature.model.constraint.resource.csl.ICslTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class CslMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.feature.model.constraint.resource.csl.mopp.CslPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.feature.model.constraint.resource.csl.ICslCommand<Object>> commands = new java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.feature.model.constraint.resource.csl.ICslCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.feature.model.constraint.resource.csl.ICslCommand<Object>> commandsToProcess = new java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.feature.model.constraint.resource.csl.ICslCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.feature.model.constraint.resource.csl.ICslTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.feature.model.constraint.resource.csl.ICslTextDiagnostic diagnostic) {
		final org.feature.model.constraint.resource.csl.ICslProblem problem = diagnostic.getProblem();
		org.feature.model.constraint.resource.csl.CslEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.feature.model.constraint.resource.csl.ICslCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.feature.model.constraint.resource.csl.CslEProblemSeverity.ERROR) {
					...
					org.feature.model.constraint.resource.csl.ICslTextDiagnostic textDiagnostic = (org.feature.model.constraint.resource.csl.ICslTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.feature.model.constraint.resource.csl.mopp.CslResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.feature.model.constraint.resource.csl.mopp.CslResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.feature.model.constraint.resource.csl.ICslQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.feature.model.constraint.resource.csl.util.CslStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.feature.model.constraint.resource.csl.CslEProblemType nextType : org.feature.model.constraint.resource.csl.CslEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.feature.model.constraint.resource.csl.CslEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.feature.model.constraint.resource.csl.CslEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.feature.model.constraint.resource.csl.CslEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.feature.model.constraint.resource.csl.util.CslRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.feature.model.constraint.resource.csl.ICslCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.feature.model.constraint.resource.csl.mopp.CslPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
