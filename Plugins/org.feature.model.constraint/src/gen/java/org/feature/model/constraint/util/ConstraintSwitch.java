   ...
   */
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID)
    {
      ...
      case ConstraintPackage.FEATURE_EXPRESSION:
      {
      ...
      case ConstraintPackage.REQUIRE:
      {
        Require require = (Require)theEObject;
        T result = caseRequire(require);
        if (result == null) result = caseFeatureExpression(require);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ConstraintPackage.EXCLUDE:
      {
        Exclude exclude = (Exclude)theEObject;
        T result = caseExclude(exclude);
        if (result == null) result = caseFeatureExpression(exclude);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
