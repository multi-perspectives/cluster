...
public class CltResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public CltResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.feature.multi.perspective.classification.resource.clt.util.CltRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.feature.multi.perspective.classification.resource.clt.util.CltEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.feature.multi.perspective.classification.resource.clt.mopp.CltResourceFactory());
		}
	}
