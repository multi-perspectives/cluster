 ...
 * code).
 */
public class CltDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.feature.multi.perspective.classification.resource.clt.debug.AbstractCltDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.feature.multi.perspective.classification.resource.clt.util.CltPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.feature.multi.perspective.classification.resource.clt.util.CltPair<String, Object>>();
	...
	public CltDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.encode('#', stack);
				org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage message = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage message = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_VARIABLES)) {
				...
				org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage message = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebugMessage(org.feature.multi.perspective.classification.resource.clt.debug.ECltDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.feature.multi.perspective.classification.resource.clt.util.CltPair<String, Object> pair = new org.feature.multi.perspective.classification.resource.clt.util.CltPair<String, Object>(name, value);
	...
	public org.feature.multi.perspective.classification.resource.clt.debug.AbstractCltDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.feature.multi.perspective.classification.resource.clt.debug.AbstractCltDebuggable debuggable) {
