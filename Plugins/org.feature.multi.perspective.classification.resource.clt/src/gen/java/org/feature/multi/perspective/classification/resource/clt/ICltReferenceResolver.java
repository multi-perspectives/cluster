 ...
 * resolver
 */
public interface ICltReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.feature.multi.perspective.classification.resource.clt.ICltConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.feature.multi.perspective.classification.resource.clt.ICltReferenceResolveResult<ReferenceType> result);
