...
public class CltResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.feature.multi.perspective.classification.resource.clt.util.CltInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.feature.multi.perspective.classification.resource.clt.util.CltInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.feature.multi.perspective.classification.resource.clt.mopp.CltResource getResource(java.io.File file) {
	...
	public static org.feature.multi.perspective.classification.resource.clt.mopp.CltResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) resource;
	}
	 ...
	 */
	public static org.feature.multi.perspective.classification.ClassificationModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.feature.multi.perspective.classification.ClassificationModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.feature.multi.perspective.classification.ClassificationModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.feature.multi.perspective.classification.ClassificationModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.feature.multi.perspective.classification.resource.clt.ICltTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
