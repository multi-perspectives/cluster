 ...
 */
public class CltPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.feature.multi.perspective.classification.resource.clt";
	/**
	...
	private static CltPlugin plugin;
	...
	public static CltPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, CltPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, CltPlugin.PLUGIN_ID, message);
		}
		final CltPlugin pluginInstance = CltPlugin.getDefault();
