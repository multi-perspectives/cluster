 ...
 */
public class CltEnumerationTerminal extends org.feature.multi.perspective.classification.resource.clt.grammar.CltTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public CltEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.feature.multi.perspective.classification.resource.clt.grammar.CltCardinality cardinality, int mandatoryOccurrencesAfter) {
