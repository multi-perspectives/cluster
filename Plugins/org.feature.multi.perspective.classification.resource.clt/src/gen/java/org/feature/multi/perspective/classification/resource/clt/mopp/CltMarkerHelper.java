 ...
 * contains
 * <code>org.feature.multi.perspective.classification.resource.clt.ICltTextDiagnost
 * ic</code>s it uses the more precise information of this extended diagnostic
 * type.
 */
public class CltMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>> commands = new java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>> commandsToProcess = new java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.feature.multi.perspective.classification.resource.clt.ICltTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.feature.multi.perspective.classification.resource.clt.ICltTextDiagnostic diagnostic) {
		final org.feature.multi.perspective.classification.resource.clt.ICltProblem problem = diagnostic.getProblem();
		org.feature.multi.perspective.classification.resource.clt.CltEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.feature.multi.perspective.classification.resource.clt.CltEProblemSeverity.ERROR) {
					...
					org.feature.multi.perspective.classification.resource.clt.ICltTextDiagnostic textDiagnostic = (org.feature.multi.perspective.classification.resource.clt.ICltTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.feature.multi.perspective.classification.resource.clt.mopp.CltResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.feature.multi.perspective.classification.resource.clt.mopp.CltResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.feature.multi.perspective.classification.resource.clt.ICltQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.feature.multi.perspective.classification.resource.clt.CltEProblemType nextType : org.feature.multi.perspective.classification.resource.clt.CltEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.feature.multi.perspective.classification.resource.clt.CltEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.feature.multi.perspective.classification.resource.clt.CltEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.feature.multi.perspective.classification.resource.clt.CltEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.feature.multi.perspective.classification.resource.clt.util.CltRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.feature.multi.perspective.classification.resource.clt.ICltCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
