 ...
 */
public class CltDefaultTokenResolver implements org.feature.multi.perspective.classification.resource.clt.ICltTokenResolver {
	 ...
	 */
	public CltDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public CltDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.feature.multi.perspective.classification.resource.clt.ICltTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.feature.multi.perspective.classification.resource.clt.grammar.CltGrammarInformationProvider.INSTANCE.getKeywords()) {
