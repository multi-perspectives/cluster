...
public class CltStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.feature.multi.perspective.classification.resource.clt.ICltFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.feature.multi.perspective.classification.resource.clt.ICltFunction1<String, T> toStringFunction) {
