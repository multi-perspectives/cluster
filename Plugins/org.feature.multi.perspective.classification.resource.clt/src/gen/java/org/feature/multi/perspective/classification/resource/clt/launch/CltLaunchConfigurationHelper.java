 ...
 * 
 */
package org.feature.multi.perspective.classification.resource.clt.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class CltLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.feature.multi.perspective.classification.resource.clt.util.AbstractCltInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.feature.multi.perspective.classification.resource.clt.util.AbstractCltInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.feature.multi.perspective.classification.resource.clt.debug.CltDebuggableInterpreter<ResultType, ContextType> interpreter = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.feature.multi.perspective.classification.resource.clt.debug.CltDebuggerListener<ResultType, ContextType> debugListener = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.feature.multi.perspective.classification.resource.clt.debug.CltDebugProcess process = new org.feature.multi.perspective.classification.resource.clt.debug.CltDebugProcess(launch);
		launch.addDebugTarget(new org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.feature.multi.perspective.classification.resource.clt.launch.CltLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.feature.multi.perspective.classification.resource.clt.util.CltResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
