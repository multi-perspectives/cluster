...
public class CltBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.feature.multi.perspective.classification.resource.clt.builder";
	
	private org.feature.multi.perspective.classification.resource.clt.ICltBuilder defaultBuilder = new org.feature.multi.perspective.classification.resource.clt.mopp.CltBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.feature.multi.perspective.classification.resource.clt.ICltBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.feature.multi.perspective.classification.resource.clt.mopp.CltResource customResource = (org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) resourceSet.getResource(uri, true);
			new org.feature.multi.perspective.classification.resource.clt.mopp.CltMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.feature.multi.perspective.classification.resource.clt.ICltBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.feature.multi.perspective.classification.resource.clt.mopp.CltMarkerHelper().getMarkerID(org.feature.multi.perspective.classification.resource.clt.CltEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.feature.multi.perspective.classification.resource.clt.mopp.CltTaskItemBuilder taskItemBuilder = new org.feature.multi.perspective.classification.resource.clt.mopp.CltTaskItemBuilder();
		new org.feature.multi.perspective.classification.resource.clt.mopp.CltMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName())) {
