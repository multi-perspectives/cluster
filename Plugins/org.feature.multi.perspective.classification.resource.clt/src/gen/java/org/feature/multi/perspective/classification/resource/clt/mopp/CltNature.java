...
public class CltNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.feature.multi.perspective.classification.resource.clt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.feature.multi.perspective.classification.resource.clt.mopp.CltBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.feature.multi.perspective.classification.resource.clt.mopp.CltBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
