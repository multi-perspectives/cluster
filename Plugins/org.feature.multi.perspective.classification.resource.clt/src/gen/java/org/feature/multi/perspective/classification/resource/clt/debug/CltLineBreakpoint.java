...
public class CltLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.feature.multi.perspective.classification.resource.clt.debug.lineBreakpoint.marker";
	
	public CltLineBreakpoint() {
		super();
	}
	
	public CltLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget target) {
		try {
	...
	public void remove(org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
