 ...
 */
public class CltMinimalModelHelper {
	
	private final static org.feature.multi.perspective.classification.resource.clt.util.CltEClassUtil eClassUtil = new org.feature.multi.perspective.classification.resource.clt.util.CltEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.feature.multi.perspective.classification.resource.clt.util.CltListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.feature.multi.perspective.classification.resource.clt.util.CltListUtil.castListUnchecked(value);
