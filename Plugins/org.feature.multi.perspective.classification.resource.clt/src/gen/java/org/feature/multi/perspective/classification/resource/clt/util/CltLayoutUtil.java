...
public class CltLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.feature.multi.perspective.classification.resource.clt.grammar.CltSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.feature.multi.perspective.classification.resource.clt.grammar.CltGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.feature.multi.perspective.classification.resource.clt.grammar.CltSyntaxElement syntaxElement = org.feature.multi.perspective.classification.resource.clt.grammar.CltGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.feature.multi.perspective.classification.resource.clt.grammar.CltPlaceholder) {
			org.feature.multi.perspective.classification.resource.clt.grammar.CltPlaceholder placeholder = (org.feature.multi.perspective.classification.resource.clt.grammar.CltPlaceholder) syntaxElement;
			org.feature.multi.perspective.classification.resource.clt.ICltTokenResolver tokenResolver = new org.feature.multi.perspective.classification.resource.clt.mopp.CltTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.feature.multi.perspective.classification.resource.clt.ICltTokenResolveResult result = new org.feature.multi.perspective.classification.resource.clt.mopp.CltTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.feature.multi.perspective.classification.resource.clt.mopp.CltLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
