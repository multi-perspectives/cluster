...
public class CltStackFrame extends org.feature.multi.perspective.classification.resource.clt.debug.CltDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget target;
	private String name;
	private int id;
	...
	public CltStackFrame(org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.decode(data, ',');
	...
	private org.feature.multi.perspective.classification.resource.clt.debug.CltDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.feature.multi.perspective.classification.resource.clt.debug.CltStackFrame other = (org.feature.multi.perspective.classification.resource.clt.debug.CltStackFrame) obj;
		if (name == null) {
