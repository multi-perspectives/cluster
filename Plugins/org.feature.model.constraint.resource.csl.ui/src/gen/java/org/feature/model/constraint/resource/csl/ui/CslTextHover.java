 ...
 */
public class CslTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.feature.model.constraint.resource.csl.ICslHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput infoInput = (org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.feature.model.constraint.resource.csl.ui.CslHyperlink hyperlink = new org.feature.model.constraint.resource.csl.ui.CslHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl iControl = new org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput) {
							org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput input = (org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl.isAvailable(parent)) {
				org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl iControl = new org.feature.model.constraint.resource.csl.ui.CslBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CslTextHover(org.feature.model.constraint.resource.csl.ICslResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.feature.model.constraint.resource.csl.ui.CslUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.insertPageProlog(buffer, 0, org.feature.model.constraint.resource.csl.ui.CslTextHover.getStyleSheet());
			org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.addPageEpilog(buffer);
			return new org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.feature.model.constraint.resource.csl.ui.CslUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.feature.model.constraint.resource.csl.util.CslStreamUtil.getContent(styleSheetURL.openStream());
