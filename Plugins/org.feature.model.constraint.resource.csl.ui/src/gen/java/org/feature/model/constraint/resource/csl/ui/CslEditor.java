...
/**
 * A text editor for 'csl' models.
 * <p>
 * This editor has id
 * <code>org.feature.model.constraint.resource.csl.ui.CslEditor</code>
 * The editor's context menu has id
 * <code>org.feature.model.constraint.resource.csl.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.feature.model.constraint.resource.csl.EditorRuler</code>.
 * </p>
 */
public class CslEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.feature.model.constraint.resource.csl.ICslResourceProvider, org.feature.model.constraint.resource.csl.ui.ICslBracketHandlerProvider, org.feature.model.constraint.resource.csl.ui.ICslAnnotationModelProvider {
	
	private org.feature.model.constraint.resource.csl.ui.CslHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.feature.model.constraint.resource.csl.ui.CslCodeFoldingManager codeFoldingManager;
	private org.feature.model.constraint.resource.csl.ui.CslBackgroundParsingStrategy bgParsingStrategy = new org.feature.model.constraint.resource.csl.ui.CslBackgroundParsingStrategy();
	private java.util.Collection<org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener>();
	private org.feature.model.constraint.resource.csl.ui.CslColorManager colorManager = new org.feature.model.constraint.resource.csl.ui.CslColorManager();
	private org.feature.model.constraint.resource.csl.ui.CslOutlinePage outlinePage;
	...
	private org.feature.model.constraint.resource.csl.ui.CslPropertySheetPage propertySheetPage;
	...
	private org.feature.model.constraint.resource.csl.ui.ICslBracketHandler bracketHandler;
	...
	public CslEditor() {
		super();
		setSourceViewerConfiguration(new org.feature.model.constraint.resource.csl.ui.CslSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), CslEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.feature.model.constraint.resource.csl.ICslTextResource currentResource = getResource();
				...
				org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.feature.model.constraint.resource.csl.EditorContext");
		setRulerContextMenuId("org.feature.model.constraint.resource.csl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.feature.model.constraint.resource.csl.ui.CslHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.feature.model.constraint.resource.csl.ui.CslCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.feature.model.constraint.resource.csl.mopp.CslNature.activate(inputFile.getProject());
		...
		org.feature.model.constraint.resource.csl.ICslTextResource loadedResource = (org.feature.model.constraint.resource.csl.ICslTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.feature.model.constraint.resource.csl.ICslTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.feature.model.constraint.resource.csl.ICslTextResource) {
					setResource((org.feature.model.constraint.resource.csl.ICslTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.feature.model.constraint.resource.csl.ui.CslUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CslEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.feature.model.constraint.resource.csl.ICslTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.feature.model.constraint.resource.csl.ui.CslOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.feature.model.constraint.resource.csl.ui.CslPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.feature.model.constraint.resource.csl.ICslTextResource textResource = (org.feature.model.constraint.resource.csl.ICslTextResource) element.eResource();
			...
			org.feature.model.constraint.resource.csl.ICslTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.feature.model.constraint.resource.csl.ICslTextToken token = lexer.getNextToken();
			...
			org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!CslEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.feature.model.constraint.resource.csl.ui.ICslBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.feature.model.constraint.resource.csl.ui.ICslBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.feature.model.constraint.resource.csl.ICslTextResource)) {
					return false;
				}
				org.feature.model.constraint.resource.csl.ICslTextResource textResource = (org.feature.model.constraint.resource.csl.ICslTextResource) resource;
				org.feature.model.constraint.resource.csl.ICslLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
