 ...
 * @since 3.2
 */
public class CslBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CslBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput);
		...
		fInput= (org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput) input;
		...
		org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.feature.model.constraint.resource.csl.ui.CslHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.feature.model.constraint.resource.csl.ui.CslDocBrowserInformationControlInput getInput() {
		return fInput;
	}
