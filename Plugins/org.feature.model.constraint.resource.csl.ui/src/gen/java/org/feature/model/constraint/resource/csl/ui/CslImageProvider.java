 ...
 */
public class CslImageProvider {
	
	public final static CslImageProvider INSTANCE = new CslImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.feature.model.constraint.resource.csl.ui.CslUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
