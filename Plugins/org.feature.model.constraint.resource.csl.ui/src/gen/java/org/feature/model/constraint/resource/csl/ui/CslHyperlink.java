 ...
 */
public class CslHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public CslHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.feature.model.constraint.resource.csl.mopp.CslPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
