 ...
 */
public class CslNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public CslNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new csl file");
