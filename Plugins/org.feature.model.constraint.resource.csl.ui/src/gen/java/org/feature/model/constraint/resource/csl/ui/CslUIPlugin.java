 ...
 */
public class CslUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.feature.model.constraint.resource.csl.ui";
	public static final String EDITOR_ID = "org.feature.model.constraint.resource.csl.ui.CslEditor";
	...
	private static CslUIPlugin plugin;
	...
	public static CslUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CslUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CslUIPlugin.PLUGIN_ID, message);
		}
		final CslUIPlugin pluginInstance = CslUIPlugin.getDefault();
