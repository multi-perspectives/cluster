...
public class CslLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.feature.model.constraint.resource.csl.mopp.CslPlugin.DEBUG_MODEL_ID);
			...
			org.feature.model.constraint.resource.csl.debug.CslLineBreakpoint lineBreakpoint = new org.feature.model.constraint.resource.csl.debug.CslLineBreakpoint(resource, lineNumber + 1);
