 ...
 * 
 */
package org.feature.model.constraint.resource.csl.ui.debug;

@SuppressWarnings("restriction")
public class CslAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getSyntaxName())) {
					return new org.feature.model.constraint.resource.csl.ui.debug.CslLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.feature.model.constraint.resource.csl.debug.CslDebugVariable) {
			final org.feature.model.constraint.resource.csl.debug.CslDebugVariable variable = (org.feature.model.constraint.resource.csl.debug.CslDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.feature.model.constraint.resource.csl.debug.CslDebugVariable) {
			final org.feature.model.constraint.resource.csl.debug.CslDebugVariable variable = (org.feature.model.constraint.resource.csl.debug.CslDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.feature.model.constraint.resource.csl.debug.CslDebugValue castedValue = (org.feature.model.constraint.resource.csl.debug.CslDebugValue) value;
