 ...
 */
public class CslOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.feature.model.constraint.resource.csl.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.feature.model.constraint.resource.csl.ui.occurences.declaration";
	...
	private org.feature.model.constraint.resource.csl.ui.CslTokenScanner tokenScanner;
	 ...
	 */
	public CslOccurrence(org.feature.model.constraint.resource.csl.ICslTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.feature.model.constraint.resource.csl.ui.CslTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.feature.model.constraint.resource.csl.ui.CslBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.feature.model.constraint.resource.csl.ui.CslPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.feature.model.constraint.resource.csl.ui.CslOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.feature.model.constraint.resource.csl.ui.CslOccurrence.DECLARATION_ANNOTATION_ID);
	}
