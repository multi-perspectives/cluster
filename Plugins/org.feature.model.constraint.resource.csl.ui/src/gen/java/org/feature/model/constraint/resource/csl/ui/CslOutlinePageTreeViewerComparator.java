...
public class CslOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			org.feature.model.constraint.resource.csl.ICslNameProvider nameProvider = new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().createNameProvider();
