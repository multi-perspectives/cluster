 ...
 */
public class CslSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public CslSyntaxColoringPreferencePage() {
		super();
		
		org.feature.model.constraint.resource.csl.mopp.CslMetaInformation metaInformation = new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.feature.model.constraint.resource.csl.ui.CslSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.feature.model.constraint.resource.csl.ui.CslPixelConverter pixelConverter = new org.feature.model.constraint.resource.csl.ui.CslPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.feature.model.constraint.resource.csl.ui.CslEditor) {
			org.feature.model.constraint.resource.csl.ui.CslEditor emfTextEditor = (org.feature.model.constraint.resource.csl.ui.CslEditor) editor;
