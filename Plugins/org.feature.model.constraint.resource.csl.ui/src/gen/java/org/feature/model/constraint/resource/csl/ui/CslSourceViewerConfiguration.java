 ...
 */
public class CslSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.feature.model.constraint.resource.csl.ui.CslQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public CslSourceViewerConfiguration(org.feature.model.constraint.resource.csl.ICslResourceProvider resourceProvider, org.feature.model.constraint.resource.csl.ui.ICslAnnotationModelProvider annotationModelProvider, org.feature.model.constraint.resource.csl.ui.ICslBracketHandlerProvider bracketHandlerProvider, org.feature.model.constraint.resource.csl.ui.CslColorManager colorManager) {
		super(org.feature.model.constraint.resource.csl.ui.CslUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.feature.model.constraint.resource.csl.ui.CslCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.feature.model.constraint.resource.csl.ui.CslTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.feature.model.constraint.resource.csl.ui.CslTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.feature.model.constraint.resource.csl.ui.CslHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.feature.model.constraint.resource.csl.ui.CslQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.feature.model.constraint.resource.csl.ui.CslIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
