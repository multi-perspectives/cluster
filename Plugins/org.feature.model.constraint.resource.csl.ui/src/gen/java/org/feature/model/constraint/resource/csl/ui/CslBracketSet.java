...
public class CslBracketSet {
	...
	private java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.feature.model.constraint.resource.csl.ICslBracketPair {
	 ...
	 */
	private class ClosingListener implements org.feature.model.constraint.resource.csl.ui.ICslBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.feature.model.constraint.resource.csl.ICslBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public CslBracketSet(org.feature.model.constraint.resource.csl.ui.CslEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslBracketPair>();
	 ...
	 */
	public org.feature.model.constraint.resource.csl.ICslBracketPair getBracketPair(String opening, String closing) {
		for (org.feature.model.constraint.resource.csl.ICslBracketPair bracketPair : bracketPairs) {
	...
	public org.feature.model.constraint.resource.csl.ICslBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.feature.model.constraint.resource.csl.ICslBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.feature.model.constraint.resource.csl.ui.CslPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.feature.model.constraint.resource.csl.ICslBracketPair remove(String opening, String closing) {
		for (org.feature.model.constraint.resource.csl.ICslBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.feature.model.constraint.resource.csl.ICslBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
