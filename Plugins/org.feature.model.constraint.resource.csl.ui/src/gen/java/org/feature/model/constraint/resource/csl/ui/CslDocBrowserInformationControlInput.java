 ...
 * olInput</code>.
 */
public class CslDocBrowserInformationControlInput {
	
	private final CslDocBrowserInformationControlInput fPrevious;
	private CslDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CslDocBrowserInformationControlInput(CslDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CslDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CslDocBrowserInformationControlInput getNext() {
		return fNext;
	}
