 ...
 */
public class CslLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.feature.model.constraint.resource.csl.launch.CslLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.feature.model.constraint.resource.csl.mopp.CslPlugin.logError("Exception while launching selection", e);
		}
	}
