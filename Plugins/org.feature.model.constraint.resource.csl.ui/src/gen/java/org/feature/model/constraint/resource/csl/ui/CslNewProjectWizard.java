 ...
 */
public class CslNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.feature.model.constraint.resource.csl.ui");
							...
							String natureID = org.feature.model.constraint.resource.csl.mopp.CslNature.NATURE_ID;
							...
							for (String builderID : org.feature.model.constraint.resource.csl.mopp.CslNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.feature.model.constraint.resource.csl.mopp.CslMetaInformation info = new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.feature.model.constraint.resource.csl.ui.CslUIPlugin.getDefault().getBundle();
