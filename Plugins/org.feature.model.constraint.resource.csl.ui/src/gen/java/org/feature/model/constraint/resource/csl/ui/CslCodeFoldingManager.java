 ...
 */
public class CslCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.feature.model.constraint.resource.csl.ui.CslEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.feature.model.constraint.resource.csl.ui.CslEditor) {
				org.feature.model.constraint.resource.csl.ui.CslEditor editor = (org.feature.model.constraint.resource.csl.ui.CslEditor) workbenchPart;
	...
	protected org.feature.model.constraint.resource.csl.ui.CslEditor editor;
	 ...
	 */
	public CslCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.feature.model.constraint.resource.csl.ui.CslEditor textEditor) {
	...
	private void addCloseListener(final org.feature.model.constraint.resource.csl.ui.CslEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.feature.model.constraint.resource.csl.ICslTextResource textResource = (org.feature.model.constraint.resource.csl.ICslTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
