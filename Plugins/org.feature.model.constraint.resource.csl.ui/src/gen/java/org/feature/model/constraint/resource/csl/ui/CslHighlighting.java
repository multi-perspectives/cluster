 ...
 */
public class CslHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.feature.model.constraint.resource.csl.ui.CslPositionHelper positionHelper = new org.feature.model.constraint.resource.csl.ui.CslPositionHelper();
	...
	private org.feature.model.constraint.resource.csl.ui.CslTokenScanner scanner;
	...
	private org.feature.model.constraint.resource.csl.ui.CslOccurrence occurrence;
	private org.feature.model.constraint.resource.csl.ui.CslBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.feature.model.constraint.resource.csl.ICslBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public CslHighlighting(org.feature.model.constraint.resource.csl.ICslTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.feature.model.constraint.resource.csl.ui.CslColorManager colorManager, org.feature.model.constraint.resource.csl.ui.CslEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.feature.model.constraint.resource.csl.ui.CslUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.feature.model.constraint.resource.csl.ui.CslTokenScanner(textResource, colorManager);
		occurrence = new org.feature.model.constraint.resource.csl.ui.CslOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.feature.model.constraint.resource.csl.ui.CslBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.feature.model.constraint.resource.csl.ui.CslPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.feature.model.constraint.resource.csl.ui.CslPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.feature.model.constraint.resource.csl.ui.CslEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.feature.model.constraint.resource.csl.ui.CslPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.feature.model.constraint.resource.csl.ui.CslPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.feature.model.constraint.resource.csl.ui.CslEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
