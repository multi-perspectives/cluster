...
public class CslAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new org.feature.model.constraint.resource.csl.ui.CslAnnotationModel(resource);
	}
