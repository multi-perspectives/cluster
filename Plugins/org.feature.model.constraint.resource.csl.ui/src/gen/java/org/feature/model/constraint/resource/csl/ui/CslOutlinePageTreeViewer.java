 ...
 * a specified depth.
 */
public class CslOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public CslOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.feature.model.constraint.resource.csl.util.CslStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.feature.model.constraint.resource.csl.ui.CslEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.feature.model.constraint.resource.csl.mopp.CslPlugin.logError("Exception while refreshing outline view", e);
		}
	}
