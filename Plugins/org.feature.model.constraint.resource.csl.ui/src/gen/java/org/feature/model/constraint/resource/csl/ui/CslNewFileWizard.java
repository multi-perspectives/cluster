...
public class CslNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.feature.model.constraint.resource.csl.ui.CslNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public CslNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.feature.model.constraint.resource.csl.ui.CslNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.feature.model.constraint.resource.csl.ui.CslUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.feature.model.constraint.resource.csl.mopp.CslMetaInformation().getSyntaxName();
	}
	
	public org.feature.model.constraint.resource.csl.ICslMetaInformation getMetaInformation() {
