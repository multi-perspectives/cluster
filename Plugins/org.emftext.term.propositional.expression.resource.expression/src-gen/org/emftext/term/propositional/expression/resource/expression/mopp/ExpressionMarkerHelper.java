...
public class ExpressionMarkerHelper {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic diagnostic) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
