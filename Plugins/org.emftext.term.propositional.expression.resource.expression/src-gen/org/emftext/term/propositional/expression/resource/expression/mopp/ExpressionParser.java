...
public class ExpressionParser extends ExpressionANTLRParserBase {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "TEXT", "WHITESPACE", "LINEBREAK", "'or'", "'and'", "'not'", "'('", "')'"
    };
    ...
    // $ANTLR start "start"
    // Expression.g:463:1: start returns [ org.eclipse.emf.ecore.EObject element = null] : (c0= parse_org_emftext_term_propositional_expression_Constraint ) EOF ;
    public final org.eclipse.emf.ecore.EObject start() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:464:1: ( (c0= parse_org_emftext_term_propositional_expression_Constraint ) EOF )
            // Expression.g:465:2: (c0= parse_org_emftext_term_propositional_expression_Constraint ) EOF
            {
            ...
            // Expression.g:472:2: (c0= parse_org_emftext_term_propositional_expression_Constraint )
            // Expression.g:473:3: c0= parse_org_emftext_term_propositional_expression_Constraint
            {
    ...
    // Expression.g:481:1: parse_org_emftext_term_propositional_expression_Constraint returns [org.emftext.term.propositional.expression.Constraint element = null] : (a0_0= parse_org_emftext_term_propositional_expression_Term ) ;
    public final org.emftext.term.propositional.expression.Constraint parse_org_emftext_term_propositional_expression_Constraint() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:484:1: ( (a0_0= parse_org_emftext_term_propositional_expression_Term ) )
            // Expression.g:485:2: (a0_0= parse_org_emftext_term_propositional_expression_Term )
            {
            // Expression.g:485:2: (a0_0= parse_org_emftext_term_propositional_expression_Term )
            // Expression.g:486:3: a0_0= parse_org_emftext_term_propositional_expression_Term
            {
    ...
    // Expression.g:512:1: parseop_Term_level_1 returns [org.emftext.term.propositional.expression.Term element = null] : leftArg= parseop_Term_level_2 ( ( () a0= 'or' rightArg= parseop_Term_level_2 )+ | ) ;
    public final org.emftext.term.propositional.expression.Term parseop_Term_level_1() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:515:1: (leftArg= parseop_Term_level_2 ( ( () a0= 'or' rightArg= parseop_Term_level_2 )+ | ) )
            // Expression.g:516:2: leftArg= parseop_Term_level_2 ( ( () a0= 'or' rightArg= parseop_Term_level_2 )+ | )
            {
            ...
            state._fsp--;
            if (state.failed) return element;
            // Expression.g:516:33: ( ( () a0= 'or' rightArg= parseop_Term_level_2 )+ | )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // Expression.g:516:34: ( () a0= 'or' rightArg= parseop_Term_level_2 )+
                    {
                    // Expression.g:516:34: ( () a0= 'or' rightArg= parseop_Term_level_2 )+
                    int cnt1=0;
                    loop1:
                    do {
                        ...
                        switch (alt1) {
                    	case 1 :
                    	    // Expression.g:517:3: () a0= 'or' rightArg= parseop_Term_level_2
                    	    {
                    	    // Expression.g:517:3: ()
                    	    // Expression.g:517:4: 
                    	    {
                    	    ...
                    	    a0=(Token)match(input,7,FOLLOW_7_in_parseop_Term_level_1172); if (state.failed) return element;
                    	    if ( state.backtracking==0 ) {
    ...
    // Expression.g:579:1: parseop_Term_level_2 returns [org.emftext.term.propositional.expression.Term element = null] : leftArg= parseop_Term_level_3 ( ( () a0= 'and' rightArg= parseop_Term_level_3 )+ | ) ;
    public final org.emftext.term.propositional.expression.Term parseop_Term_level_2() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:582:1: (leftArg= parseop_Term_level_3 ( ( () a0= 'and' rightArg= parseop_Term_level_3 )+ | ) )
            // Expression.g:583:1: leftArg= parseop_Term_level_3 ( ( () a0= 'and' rightArg= parseop_Term_level_3 )+ | )
            {
            ...
            state._fsp--;
            if (state.failed) return element;
            // Expression.g:583:31: ( ( () a0= 'and' rightArg= parseop_Term_level_3 )+ | )
            int alt4=2;
            ...
            else if ( (LA4_0==EOF||LA4_0==7||LA4_0==11) ) {
                alt4=2;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return element;}
            ...
            switch (alt4) {
                case 1 :
                    // Expression.g:583:32: ( () a0= 'and' rightArg= parseop_Term_level_3 )+
                    {
                    // Expression.g:583:32: ( () a0= 'and' rightArg= parseop_Term_level_3 )+
                    int cnt3=0;
                    loop3:
                    do {
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // Expression.g:584:2: () a0= 'and' rightArg= parseop_Term_level_3
                    	    {
                    	    // Expression.g:584:2: ()
                    	    // Expression.g:584:3: 
                    	    {
                    	    ...
                    	    a0=(Token)match(input,8,FOLLOW_8_in_parseop_Term_level_2251); if (state.failed) return element;
                    	    if ( state.backtracking==0 ) {
    ...
    // Expression.g:646:1: parseop_Term_level_3 returns [org.emftext.term.propositional.expression.Term element = null] : (a0= 'not' arg= parseop_Term_level_4 | arg= parseop_Term_level_4 );
    public final org.emftext.term.propositional.expression.Term parseop_Term_level_3() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:649:1: (a0= 'not' arg= parseop_Term_level_4 | arg= parseop_Term_level_4 )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // Expression.g:650:1: a0= 'not' arg= parseop_Term_level_4
                    {
                    a0=(Token)match(input,9,FOLLOW_9_in_parseop_Term_level_3306); if (state.failed) return element;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // Expression.g:687:1: arg= parseop_Term_level_4
                    {
    ...
    // Expression.g:690:1: parseop_Term_level_4 returns [org.emftext.term.propositional.expression.Term element = null] : (c0= parse_org_emftext_term_propositional_expression_Nested | c1= parse_org_emftext_term_propositional_expression_FeatureRef );
    public final org.emftext.term.propositional.expression.Term parseop_Term_level_4() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:693:1: (c0= parse_org_emftext_term_propositional_expression_Nested | c1= parse_org_emftext_term_propositional_expression_FeatureRef )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // Expression.g:694:1: c0= parse_org_emftext_term_propositional_expression_Nested
                    {
                    ...
                    break;
                case 2 :
                    // Expression.g:695:2: c1= parse_org_emftext_term_propositional_expression_FeatureRef
                    {
    ...
    // Expression.g:698:1: parse_org_emftext_term_propositional_expression_Nested returns [org.emftext.term.propositional.expression.Nested element = null] : a0= '(' (a1_0= parse_org_emftext_term_propositional_expression_Term ) a2= ')' ;
    public final org.emftext.term.propositional.expression.Nested parse_org_emftext_term_propositional_expression_Nested() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:701:1: (a0= '(' (a1_0= parse_org_emftext_term_propositional_expression_Term ) a2= ')' )
            // Expression.g:702:1: a0= '(' (a1_0= parse_org_emftext_term_propositional_expression_Term ) a2= ')'
            {
            a0=(Token)match(input,10,FOLLOW_10_in_parse_org_emftext_term_propositional_expression_Nested379); if (state.failed) return element;
            if ( state.backtracking==0 ) {
            ...
            // Expression.g:718:1: (a1_0= parse_org_emftext_term_propositional_expression_Term )
            // Expression.g:719:1: a1_0= parse_org_emftext_term_propositional_expression_Term
            {
            ...
            a2=(Token)match(input,11,FOLLOW_11_in_parse_org_emftext_term_propositional_expression_Nested404); if (state.failed) return element;
            if ( state.backtracking==0 ) {
    ...
    // Expression.g:762:1: parse_org_emftext_term_propositional_expression_FeatureRef returns [org.emftext.term.propositional.expression.FeatureRef element = null] : (a0= TEXT ) ;
    public final org.emftext.term.propositional.expression.FeatureRef parse_org_emftext_term_propositional_expression_FeatureRef() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:765:1: ( (a0= TEXT ) )
            // Expression.g:766:1: (a0= TEXT )
            {
            // Expression.g:766:1: (a0= TEXT )
            // Expression.g:767:1: a0= TEXT
            {
    ...
    // Expression.g:810:1: parse_org_emftext_term_propositional_expression_Term returns [org.emftext.term.propositional.expression.Term element = null] : c= parseop_Term_level_1 ;
    public final org.emftext.term.propositional.expression.Term parse_org_emftext_term_propositional_expression_Term() throws RecognitionException {
        ...
        try {
            ...
            // Expression.g:811:1: (c= parseop_Term_level_1 )
            // Expression.g:812:1: c= parseop_Term_level_1
            {
            ...
            if (state.failed) return element;
            if ( state.backtracking==0 ) {
               element = c; /* this rule is an expression root */ 
            }
    ...
    public static final BitSet FOLLOW_parseop_Term_level_2_in_parseop_Term_level_1152 = new BitSet(new long[]{0x0000000000000082L});
    public static final BitSet FOLLOW_7_in_parseop_Term_level_1172 = new BitSet(new long[]{0x0000000000000610L});
    public static final BitSet FOLLOW_parseop_Term_level_2_in_parseop_Term_level_1189 = new BitSet(new long[]{0x0000000000000082L});
    public static final BitSet FOLLOW_parseop_Term_level_3_in_parseop_Term_level_2235 = new BitSet(new long[]{0x0000000000000102L});
    public static final BitSet FOLLOW_8_in_parseop_Term_level_2251 = new BitSet(new long[]{0x0000000000000610L});
    public static final BitSet FOLLOW_parseop_Term_level_3_in_parseop_Term_level_2265 = new BitSet(new long[]{0x0000000000000102L});
    public static final BitSet FOLLOW_9_in_parseop_Term_level_3306 = new BitSet(new long[]{0x0000000000000610L});
    ...
    public static final BitSet FOLLOW_10_in_parse_org_emftext_term_propositional_expression_Nested379 = new BitSet(new long[]{0x0000000000000610L});
    public static final BitSet FOLLOW_parse_org_emftext_term_propositional_expression_Term_in_parse_org_emftext_term_propositional_expression_Nested392 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_parse_org_emftext_term_propositional_expression_Nested404 = new BitSet(new long[]{0x0000000000000002L});
