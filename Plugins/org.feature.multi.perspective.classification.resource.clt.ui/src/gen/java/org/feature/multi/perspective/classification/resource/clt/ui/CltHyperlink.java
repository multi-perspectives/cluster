 ...
 */
public class CltHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public CltHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
