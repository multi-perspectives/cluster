 ...
 * hovers, is a proxy.
 */
public class CltHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public CltHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.feature.multi.perspective.classification.resource.clt.ui.CltHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
