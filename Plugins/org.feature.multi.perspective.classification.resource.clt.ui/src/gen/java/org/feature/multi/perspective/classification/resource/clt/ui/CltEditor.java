...
/**
 * A text editor for 'clt' models.
 * <p>
 * This editor has id
 * <code>org.feature.multi.perspective.classification.resource.clt.ui.CltEditor</co
 * de>
 * The editor's context menu has id
 * <code>org.feature.multi.perspective.classification.resource.clt.EditorContext</c
 * ode>.
 * The editor's ruler context menu has id
 * <code>org.feature.multi.perspective.classification.resource.clt.EditorRuler</cod
 * e>.
 * </p>
 */
public class CltEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.feature.multi.perspective.classification.resource.clt.ICltResourceProvider, org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandlerProvider, org.feature.multi.perspective.classification.resource.clt.ui.ICltAnnotationModelProvider {
	
	private org.feature.multi.perspective.classification.resource.clt.ui.CltHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.feature.multi.perspective.classification.resource.clt.ui.CltCodeFoldingManager codeFoldingManager;
	private org.feature.multi.perspective.classification.resource.clt.ui.CltBackgroundParsingStrategy bgParsingStrategy = new org.feature.multi.perspective.classification.resource.clt.ui.CltBackgroundParsingStrategy();
	private java.util.Collection<org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener>();
	private org.feature.multi.perspective.classification.resource.clt.ui.CltColorManager colorManager = new org.feature.multi.perspective.classification.resource.clt.ui.CltColorManager();
	private org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePage outlinePage;
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltPropertySheetPage propertySheetPage;
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandler bracketHandler;
	...
	public CltEditor() {
		super();
		setSourceViewerConfiguration(new org.feature.multi.perspective.classification.resource.clt.ui.CltSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), CltEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.feature.multi.perspective.classification.resource.clt.ICltTextResource currentResource = getResource();
				...
				org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.feature.multi.perspective.classification.resource.clt.EditorContext");
		setRulerContextMenuId("org.feature.multi.perspective.classification.resource.clt.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.feature.multi.perspective.classification.resource.clt.ui.CltHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.feature.multi.perspective.classification.resource.clt.ui.CltCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.feature.multi.perspective.classification.resource.clt.mopp.CltNature.activate(inputFile.getProject());
		...
		org.feature.multi.perspective.classification.resource.clt.ICltTextResource loadedResource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.feature.multi.perspective.classification.resource.clt.ICltTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.feature.multi.perspective.classification.resource.clt.ICltTextResource) {
					setResource((org.feature.multi.perspective.classification.resource.clt.ICltTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CltEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.feature.multi.perspective.classification.resource.clt.ui.CltPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) element.eResource();
			org.feature.multi.perspective.classification.resource.clt.ICltLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.feature.multi.perspective.classification.resource.clt.ICltTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.feature.multi.perspective.classification.resource.clt.ICltTextToken token = lexer.getNextToken();
			...
			org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!CltEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.feature.multi.perspective.classification.resource.clt.ICltTextResource)) {
					return false;
				}
				org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) resource;
				org.feature.multi.perspective.classification.resource.clt.ICltLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
