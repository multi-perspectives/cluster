 ...
 */
public class CltNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public CltNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new clt file");
