 ...
 */
public class CltOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.feature.multi.perspective.classification.resource.clt.ui.outlinecontext";
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePageTreeViewer treeViewer;
	private org.eclipse.core.runtime.ListenerList selectionChangedListeners = new org.eclipse.core.runtime.ListenerList();
	
	public CltOutlinePage(org.feature.multi.perspective.classification.resource.clt.ICltResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.feature.multi.perspective.classification.resource.clt.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.feature.multi.perspective.classification.resource.clt.ui.CltOutlinePageActionProvider().getActions(treeViewer);
