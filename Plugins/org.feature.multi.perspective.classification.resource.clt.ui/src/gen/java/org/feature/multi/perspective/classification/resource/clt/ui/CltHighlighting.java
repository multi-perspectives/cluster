 ...
 */
public class CltHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.feature.multi.perspective.classification.resource.clt.ui.CltPositionHelper positionHelper = new org.feature.multi.perspective.classification.resource.clt.ui.CltPositionHelper();
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltTokenScanner scanner;
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.feature.multi.perspective.classification.resource.clt.ui.CltOccurrence occurrence;
	private org.feature.multi.perspective.classification.resource.clt.ui.CltBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public CltHighlighting(org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.feature.multi.perspective.classification.resource.clt.ui.CltColorManager colorManager, org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.feature.multi.perspective.classification.resource.clt.ui.CltTokenScanner(textResource, colorManager);
		occurrence = new org.feature.multi.perspective.classification.resource.clt.ui.CltOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.feature.multi.perspective.classification.resource.clt.ui.CltBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.feature.multi.perspective.classification.resource.clt.ui.CltPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.feature.multi.perspective.classification.resource.clt.ui.CltPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.feature.multi.perspective.classification.resource.clt.ui.CltEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
