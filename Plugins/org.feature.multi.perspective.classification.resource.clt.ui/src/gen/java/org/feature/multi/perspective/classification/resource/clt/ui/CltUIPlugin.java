 ...
 */
public class CltUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.feature.multi.perspective.classification.resource.clt.ui";
	public static final String EDITOR_ID = "org.feature.multi.perspective.classification.resource.clt.ui.CltEditor";
	...
	private static CltUIPlugin plugin;
	...
	public static CltUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CltUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CltUIPlugin.PLUGIN_ID, message);
		}
		final CltUIPlugin pluginInstance = CltUIPlugin.getDefault();
