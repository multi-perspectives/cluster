...
public class CltMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.feature.multi.perspective.classification.resource.clt.ICltOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) {
					org.feature.multi.perspective.classification.resource.clt.mopp.CltResource customResource = (org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.feature.multi.perspective.classification.resource.clt.ICltQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.feature.multi.perspective.classification.resource.clt.ICltQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.feature.multi.perspective.classification.resource.clt.ICltQuickFix> getQuickFixes(org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.feature.multi.perspective.classification.resource.clt.ICltQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
