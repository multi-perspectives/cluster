...
public class CltLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.DEBUG_MODEL_ID);
			...
			org.feature.multi.perspective.classification.resource.clt.debug.CltLineBreakpoint lineBreakpoint = new org.feature.multi.perspective.classification.resource.clt.debug.CltLineBreakpoint(resource, lineNumber + 1);
