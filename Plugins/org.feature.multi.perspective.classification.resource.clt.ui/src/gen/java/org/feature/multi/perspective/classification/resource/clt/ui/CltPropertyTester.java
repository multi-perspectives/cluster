...
public class CltPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName());
	}
