 ...
 * a specified depth.
 */
public class CltOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public CltOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.feature.multi.perspective.classification.resource.clt.util.CltStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.feature.multi.perspective.classification.resource.clt.ui.CltEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.logError("Exception while refreshing outline view", e);
		}
	}
