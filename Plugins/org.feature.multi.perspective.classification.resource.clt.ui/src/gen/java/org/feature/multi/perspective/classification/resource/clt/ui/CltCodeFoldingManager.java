 ...
 */
public class CltCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.feature.multi.perspective.classification.resource.clt.ICltBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.feature.multi.perspective.classification.resource.clt.ui.CltEditor) {
				org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor = (org.feature.multi.perspective.classification.resource.clt.ui.CltEditor) workbenchPart;
	...
	protected org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor;
	 ...
	 */
	public CltCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.feature.multi.perspective.classification.resource.clt.ui.CltEditor textEditor) {
	...
	private void addCloseListener(final org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource = (org.feature.multi.perspective.classification.resource.clt.ICltTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
