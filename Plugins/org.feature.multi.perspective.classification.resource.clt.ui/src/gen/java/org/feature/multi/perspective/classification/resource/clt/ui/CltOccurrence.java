 ...
 */
public class CltOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.feature.multi.perspective.classification.resource.clt.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.feature.multi.perspective.classification.resource.clt.ui.occurences.declaration";
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltTokenScanner tokenScanner;
	...
	private org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource;
	 ...
	 */
	public CltOccurrence(org.feature.multi.perspective.classification.resource.clt.ICltTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.feature.multi.perspective.classification.resource.clt.ui.CltTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.feature.multi.perspective.classification.resource.clt.ui.CltBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.feature.multi.perspective.classification.resource.clt.ui.CltOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.feature.multi.perspective.classification.resource.clt.ui.CltOccurrence.DECLARATION_ANNOTATION_ID);
	}
