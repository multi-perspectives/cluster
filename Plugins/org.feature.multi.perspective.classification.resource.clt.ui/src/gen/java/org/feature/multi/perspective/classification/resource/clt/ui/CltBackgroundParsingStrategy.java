 ...
 */
public class CltBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource, final org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource, final org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.feature.multi.perspective.classification.resource.clt.ICltTextResource resource, final org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) {
							org.feature.multi.perspective.classification.resource.clt.mopp.CltResource concreteResource = (org.feature.multi.perspective.classification.resource.clt.mopp.CltResource) resource;
