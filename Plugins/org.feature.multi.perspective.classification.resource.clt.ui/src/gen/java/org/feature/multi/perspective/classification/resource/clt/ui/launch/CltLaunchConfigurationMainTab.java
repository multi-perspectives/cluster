 ...
 * class.
 */
public class CltLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			uriText.setText(configuration.getAttribute(org.feature.multi.perspective.classification.resource.clt.launch.CltLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(org.feature.multi.perspective.classification.resource.clt.launch.CltLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uriText.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return org.feature.multi.perspective.classification.resource.clt.ui.CltImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.addFilter(new org.eclipse.jface.viewers.ViewerFilter() {
			...
			public boolean select(org.eclipse.jface.viewers.Viewer viewer, Object parentElement, Object element) {
				if (element instanceof org.eclipse.core.resources.IFile) {
					...
					return file.getFileExtension().equals(new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName());
				}
				return true;
			}
		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
