 ...
 * olInput</code>.
 */
public class CltDocBrowserInformationControlInput {
	
	private final CltDocBrowserInformationControlInput fPrevious;
	private CltDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CltDocBrowserInformationControlInput(CltDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CltDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CltDocBrowserInformationControlInput getNext() {
		return fNext;
	}
