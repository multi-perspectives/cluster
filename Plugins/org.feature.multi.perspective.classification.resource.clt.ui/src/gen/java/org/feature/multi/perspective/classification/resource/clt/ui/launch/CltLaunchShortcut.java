 ...
 */
public class CltLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.feature.multi.perspective.classification.resource.clt.launch.CltLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.feature.multi.perspective.classification.resource.clt.mopp.CltPlugin.logError("Exception while launching selection", e);
		}
	}
