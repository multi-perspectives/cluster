...
public class CltNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.feature.multi.perspective.classification.resource.clt.ui.CltNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public CltNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.feature.multi.perspective.classification.resource.clt.ui.CltNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName();
	}
