...
public class CltBracketSet {
	...
	private java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.feature.multi.perspective.classification.resource.clt.ICltBracketPair {
	 ...
	 */
	private class ClosingListener implements org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.feature.multi.perspective.classification.resource.clt.ICltBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public CltBracketSet(org.feature.multi.perspective.classification.resource.clt.ui.CltEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltBracketPair>();
	 ...
	 */
	public org.feature.multi.perspective.classification.resource.clt.ICltBracketPair getBracketPair(String opening, String closing) {
		for (org.feature.multi.perspective.classification.resource.clt.ICltBracketPair bracketPair : bracketPairs) {
	...
	public org.feature.multi.perspective.classification.resource.clt.ICltBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.feature.multi.perspective.classification.resource.clt.ICltBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.feature.multi.perspective.classification.resource.clt.ui.CltPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.feature.multi.perspective.classification.resource.clt.ICltBracketPair remove(String opening, String closing) {
		for (org.feature.multi.perspective.classification.resource.clt.ICltBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.feature.multi.perspective.classification.resource.clt.ICltBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.feature.multi.perspective.classification.resource.clt.ui.CltPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
