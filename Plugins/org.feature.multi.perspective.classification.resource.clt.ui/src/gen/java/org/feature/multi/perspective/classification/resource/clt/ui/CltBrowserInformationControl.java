 ...
 * @since 3.2
 */
public class CltBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CltBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CltBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CltBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput);
		...
		fInput= (org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput) input;
		...
		org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput getInput() {
		return fInput;
	}
