 ...
 */
public class CltNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.feature.multi.perspective.classification.resource.clt.ui");
							...
							String natureID = org.feature.multi.perspective.classification.resource.clt.mopp.CltNature.NATURE_ID;
							...
							for (String builderID : org.feature.multi.perspective.classification.resource.clt.mopp.CltNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation info = new org.feature.multi.perspective.classification.resource.clt.mopp.CltMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.getDefault().getBundle();
