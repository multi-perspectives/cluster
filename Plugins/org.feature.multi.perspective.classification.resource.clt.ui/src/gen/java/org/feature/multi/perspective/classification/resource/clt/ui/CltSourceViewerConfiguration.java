 ...
 */
public class CltSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public CltSourceViewerConfiguration(org.feature.multi.perspective.classification.resource.clt.ICltResourceProvider resourceProvider, org.feature.multi.perspective.classification.resource.clt.ui.ICltAnnotationModelProvider annotationModelProvider, org.feature.multi.perspective.classification.resource.clt.ui.ICltBracketHandlerProvider bracketHandlerProvider, org.feature.multi.perspective.classification.resource.clt.ui.CltColorManager colorManager) {
		super(org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.feature.multi.perspective.classification.resource.clt.ui.CltCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.feature.multi.perspective.classification.resource.clt.ui.CltTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.feature.multi.perspective.classification.resource.clt.ui.CltTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.feature.multi.perspective.classification.resource.clt.ui.CltHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.feature.multi.perspective.classification.resource.clt.ui.CltQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.feature.multi.perspective.classification.resource.clt.ui.CltIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
