 ...
 */
public class CltTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.feature.multi.perspective.classification.resource.clt.ICltHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput infoInput = (org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.feature.multi.perspective.classification.resource.clt.ui.CltHyperlink hyperlink = new org.feature.multi.perspective.classification.resource.clt.ui.CltHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl iControl = new org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput) {
							org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput input = (org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl.isAvailable(parent)) {
				org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl iControl = new org.feature.multi.perspective.classification.resource.clt.ui.CltBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CltTextHover(org.feature.multi.perspective.classification.resource.clt.ICltResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.feature.multi.perspective.classification.resource.clt.ui.CltUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.insertPageProlog(buffer, 0, org.feature.multi.perspective.classification.resource.clt.ui.CltTextHover.getStyleSheet());
			org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.addPageEpilog(buffer);
			return new org.feature.multi.perspective.classification.resource.clt.ui.CltDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.feature.multi.perspective.classification.resource.clt.ui.CltHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.feature.multi.perspective.classification.resource.clt.ui.CltUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.feature.multi.perspective.classification.resource.clt.util.CltStreamUtil.getContent(styleSheetURL.openStream());
