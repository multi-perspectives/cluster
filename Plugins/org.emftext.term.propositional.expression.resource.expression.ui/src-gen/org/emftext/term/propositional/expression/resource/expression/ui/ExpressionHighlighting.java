 ...
 */
public class ExpressionHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionHelper positionHelper = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionHelper();
	...
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionTokenScanner scanner;
	...
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOccurrence occurrence;
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public ExpressionHighlighting(org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionColorManager colorManager, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
