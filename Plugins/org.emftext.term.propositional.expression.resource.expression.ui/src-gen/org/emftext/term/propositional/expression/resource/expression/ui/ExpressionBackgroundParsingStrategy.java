 ...
 */
public class ExpressionBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource, final org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource, final org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource, final org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
