 ...
 */
public class ExpressionNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public ExpressionNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new expression file");
