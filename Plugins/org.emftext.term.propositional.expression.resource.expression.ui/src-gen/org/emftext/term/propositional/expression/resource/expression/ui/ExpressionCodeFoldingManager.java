 ...
 */
public class ExpressionCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor) {
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor = (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor) workbenchPart;
	...
	protected org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor;
	 ...
	 */
	public ExpressionCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource textResource = (org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
