...
public class ClassificationCache {
	...
	private ViewBuilder getViewBuilder(EObject classificationObject) {
		...
		EObject rootContainer = EcoreUtil
				.getRootContainer(classificationObject);
	 ...
	 * @return
	 */
	public boolean isFeatureContainedInFirstView(Classification classification,
			Feature feature) {
		AbstractGroup viewgroup = classification.getViewgroups().get(0);
		ViewBuilder viewBuilder = getViewBuilder(classification);
	 ...
	 * @return
	 */
	public boolean isFeatureContainedInAnyViews(Classification classification,
			Feature feature) {
