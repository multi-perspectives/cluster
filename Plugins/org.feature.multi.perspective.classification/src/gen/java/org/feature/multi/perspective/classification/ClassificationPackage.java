...
public interface ClassificationPackage extends EPackage {
   ...
   * @ordered
   */
   int CLASSIFICATION__VIEWGROUP = 0;
   ...
   */
   ...
   /**
   * Returns the meta object for the reference '{@link org.feature.multi.perspective.classification.Classification#getViewgroup <em>Viewgroup</em>}'.
   * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Viewgroup</em>'.
   * @see org.feature.multi.perspective.classification.Classification#getViewgroup()
   * @see #getClassification()
   * @generated
   */
   EReference getClassification_Viewgroup();
   ...
   */
   interface Literals {
     ...
     * @generated
     */
      EReference CLASSIFICATION__VIEWGROUP = eINSTANCE.getClassification_Viewgroup();
