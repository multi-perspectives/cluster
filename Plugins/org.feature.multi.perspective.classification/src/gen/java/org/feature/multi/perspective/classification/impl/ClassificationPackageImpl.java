...
public class ClassificationPackageImpl extends EPackageImpl implements ClassificationPackage {
   ...
   * @generated
   */
   public EReference getClassification_Viewgroup() {
   ...
   */
   public void createPackageContents() {
    ...
    createEReference(classificationEClass, CLASSIFICATION__VIEWGROUP);
   ...
   */
   public void initializePackageContents() {
    ...
    initEReference(getClassification_Viewgroup(), theViewmodelPackage.getAbstractGroup(), null, "viewgroup", null, 0, 1, Classification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
