...
//      List<FeatureExpression> parseExpressions = ConstraintParser.parseExpressions(model);
//      for (FeatureExpression featureExpression : parseExpressions) {
//         Constraint compound = checkExpression(featureExpression);
