 ...
 * $Id$
 */
package org.feature.multi.perspective.model.cluster.impl;
 ...
 * <ul>
 *   <li>{@link org.feature.multi.perspective.model.cluster.impl.GroupModelImpl#getCoreGroup <em>Core Group</em>}</li>
 *   <li>{@link org.feature.multi.perspective.model.cluster.impl.GroupModelImpl#getViewPointContainer <em>View Point Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupModelImpl extends EObjectImpl implements GroupModel {
   ...
   public NotificationChain basicSetViewPointContainer(ViewPointContainer newViewPointContainer, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClusterPackage.GROUP_MODEL__VIEW_POINT_CONTAINER, oldViewPointContainer, newViewPointContainer);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setViewPointContainer(ViewPointContainer newViewPointContainer) {
      if (newViewPointContainer != viewPointContainer) {
         ...
         if (viewPointContainer != null)
            msgs = ((InternalEObject)viewPointContainer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ClusterPackage.GROUP_MODEL__VIEW_POINT_CONTAINER, null, msgs);
         if (newViewPointContainer != null)
            msgs = ((InternalEObject)newViewPointContainer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ClusterPackage.GROUP_MODEL__VIEW_POINT_CONTAINER, null, msgs);
         msgs = basicSetViewPointContainer(newViewPointContainer, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, ClusterPackage.GROUP_MODEL__VIEW_POINT_CONTAINER, newViewPointContainer, newViewPointContainer));
   }
    ...
    */
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         ...
         case ClusterPackage.GROUP_MODEL__VIEW_POINT_CONTAINER:
