 ...
 * a specified depth.
 */
public class ExpressionOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public ExpressionOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.term.propositional.expression.resource.expression.util.ExpressionStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logError("Exception while refreshing outline view", e);
		}
	}
