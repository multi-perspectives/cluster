 ...
 */
public class ExpressionIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
