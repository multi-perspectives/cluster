...
public class ExpressionSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPixelConverter pixelConverter = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor) {
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor emfTextEditor = (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor) editor;
