...
/**
 * A text editor for 'expression' models.
 */
public class ExpressionEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.term.propositional.expression.resource.expression.IExpressionResourceProvider, org.emftext.term.propositional.expression.resource.expression.ui.IExpressionBracketHandlerProvider, org.emftext.term.propositional.expression.resource.expression.ui.IExpressionAnnotationModelProvider {
	
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCodeFoldingManager codeFoldingManager;
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBackgroundParsingStrategy bgParsingStrategy = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener>();
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionColorManager colorManager = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionColorManager();
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOutlinePage outlinePage;
	...
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPropertySheetPage propertySheetPage;
	...
	private org.emftext.term.propositional.expression.resource.expression.ui.IExpressionBracketHandler bracketHandler;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), ExpressionEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource currentResource = getResource();
				...
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.term.propositional.expression.resource.expression.EditorContext");
		setRulerContextMenuId("org.emftext.term.propositional.expression.resource.expression.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionNature.activate(inputFile.getProject());
		...
		org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource loadedResource = (org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource) {
					setResource((org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the ExpressionEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.emftext.term.propositional.expression.resource.expression.IExpressionTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.term.propositional.expression.resource.expression.IExpressionTextToken token = lexer.getNextToken();
			...
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!ExpressionEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.term.propositional.expression.resource.expression.IExpressionBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.term.propositional.expression.resource.expression.ui.IExpressionBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.term.propositional.expression.resource.expression.ui.IExpressionBracketHandler bracketHandler) {
