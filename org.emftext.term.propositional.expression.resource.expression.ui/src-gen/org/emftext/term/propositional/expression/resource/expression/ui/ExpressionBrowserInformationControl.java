 ...
 * @since 3.2
 */
public class ExpressionBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput fInput;
	 ...
	 */
	public ExpressionBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public ExpressionBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public ExpressionBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput) input;
		...
		org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput getInput() {
		return fInput;
	}
