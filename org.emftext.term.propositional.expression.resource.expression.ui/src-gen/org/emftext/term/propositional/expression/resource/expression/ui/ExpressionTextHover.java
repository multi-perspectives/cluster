 ...
 */
public class ExpressionTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.term.propositional.expression.resource.expression.IExpressionHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput infoInput = (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHyperlink hyperlink = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl iControl = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput) {
							org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput input = (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl.isAvailable(parent)) {
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl iControl = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public ExpressionTextHover(org.emftext.term.propositional.expression.resource.expression.IExpressionResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIMetaInformation().getHoverTextProvider();
	}
	 ...
	 */
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionTextHover.getStyleSheet());
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.term.propositional.expression.resource.expression.ui.ExpressionHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.term.propositional.expression.resource.expression.util.ExpressionStreamUtil.getContent(styleSheetURL.openStream());
