...
public class ExpressionOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			org.emftext.term.propositional.expression.resource.expression.IExpressionNameProvider nameProvider = new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation().createNameProvider();
