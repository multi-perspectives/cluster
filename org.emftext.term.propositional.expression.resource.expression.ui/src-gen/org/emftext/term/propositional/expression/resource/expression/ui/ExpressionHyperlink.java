 ...
 */
public class ExpressionHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public ExpressionHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
