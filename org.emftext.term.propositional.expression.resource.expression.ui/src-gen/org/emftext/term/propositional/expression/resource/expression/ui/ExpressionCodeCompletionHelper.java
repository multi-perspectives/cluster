 ...
 */
public class ExpressionCodeCompletionHelper {
	 ...
	 * @return
	 */
	public org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal[] computeCompletionProposals(org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource originalResource, String content, int cursorOffset) {
		...
		org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource = (org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource) resourceSet.createResource(originalResource.getURI());
		...
		org.emftext.term.propositional.expression.resource.expression.IExpressionTextParser parser = metaInformation.createParser(inputStream, null);
		org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[] expectedElements = parseToExpectedElements(parser, resource, cursorOffset);
		if (expectedElements == null) {
			return new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal[0];
		}
		if (expectedElements.length == 0) {
			return new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal[0];
		}
		java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal> expectedAfterCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset));
		java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal> expectedBeforeCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset - 1));
	...
	public org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[] parseToExpectedElements(org.emftext.term.propositional.expression.resource.expression.IExpressionTextParser parser, org.emftext.term.propositional.expression.resource.expression.IExpressionTextResource resource, int cursorOffset) {
		final java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal> expectedElements = parser.parseToExpectedElements(null, resource, cursorOffset);
		if (expectedElements == null) {
			return new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[0];
		}
	...
	protected java.util.Collection<org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal> handleEnumAttribute(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal expectedTerminal, org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		...
		for (org.eclipse.emf.ecore.EEnumLiteral literal : enumLiterals) {
			...
			org.emftext.term.propositional.expression.resource.expression.IExpressionTokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
	...
	protected java.util.Collection<org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal> handleNCReference(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		org.emftext.term.propositional.expression.resource.expression.IExpressionTokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
		org.emftext.term.propositional.expression.resource.expression.IExpressionReferenceResolveResult<org.eclipse.emf.ecore.EObject> result = new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionReferenceResolveResult<org.eclipse.emf.ecore.EObject>(true);
		resolverSwitch.resolveFuzzy(prefix, container, reference, 0, result);
		java.util.Collection<org.emftext.term.propositional.expression.resource.expression.IExpressionReferenceMapping<org.eclipse.emf.ecore.EObject>> mappings = result.getMappings();
		if (mappings != null) {
			java.util.Collection<org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal> resultSet = new java.util.LinkedHashSet<org.emftext.term.propositional.expression.resource.expression.ui.ExpressionCompletionProposal>();
			for (org.emftext.term.propositional.expression.resource.expression.IExpressionReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				org.eclipse.swt.graphics.Image image = null;
				if (mapping instanceof org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionElementMapping<?>) {
					org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionElementMapping<?> elementMapping = (org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionElementMapping<?>) mapping;
	...
	public org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[] getElementsExpectedAt(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[] allExpectedElements, int cursorOffset) {
		java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal> expectedAtCursor = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal>();
		for (int i = 0; i < allExpectedElements.length; i++) {
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal expectedElement = allExpectedElements[i];
	...
	protected int getEnd(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal[] allExpectedElements, int indexInList) {
		...
		for (int i = indexInList + 1; i < allExpectedElements.length; i++) {
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionExpectedTerminal elementAtI = allExpectedElements[i];
