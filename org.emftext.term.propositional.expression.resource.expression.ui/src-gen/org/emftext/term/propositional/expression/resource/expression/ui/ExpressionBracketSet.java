 ...
 */
public class ExpressionBracketSet {
	...
	private java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.term.propositional.expression.resource.expression.ui.IExpressionBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public ExpressionBracketSet(org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair>();
	 ...
	 */
	public org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair remove(String opening, String closing) {
		for (org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.term.propositional.expression.resource.expression.ui.ExpressionPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
