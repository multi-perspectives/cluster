 ...
 */
public class ExpressionUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.term.propositional.expression.resource.expression.ui";
	public static final String EDITOR_ID = "org.emftext.term.propositional.expression.resource.expression.ui.ExpressionEditor";
	...
	private static ExpressionUIPlugin plugin;
	
	public ExpressionUIPlugin() {
		super();
	}
	...
	public static ExpressionUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ExpressionUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ExpressionUIPlugin.PLUGIN_ID, message);
		}
		final ExpressionUIPlugin pluginInstance = ExpressionUIPlugin.getDefault();
