 ...
 */
public class ExpressionNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public ExpressionNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.term.propositional.expression.resource.expression.ui");
							...
							String natureID = org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionNature.NATURE_ID;
							...
							for (String builderID : org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation info = new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation();
