 ...
 */
public class ExpressionOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.term.propositional.expression.resource.expression.ui.outlinecontext";
	...
	public ExpressionOutlinePage(org.emftext.term.propositional.expression.resource.expression.IExpressionResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.term.propositional.expression.resource.expression.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionOutlinePageActionProvider().getActions(treeViewer);
