...
public class ExpressionNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.term.propositional.expression.resource.expression.ui.ExpressionNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public ExpressionNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.term.propositional.expression.resource.expression.ui.ExpressionNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.term.propositional.expression.resource.expression.ui.ExpressionUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMetaInformation().getSyntaxName();
	}
