 ...
 * olInput</code>.
 */
public class ExpressionDocBrowserInformationControlInput {
	
	private final ExpressionDocBrowserInformationControlInput fPrevious;
	private ExpressionDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ExpressionDocBrowserInformationControlInput(ExpressionDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ExpressionDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ExpressionDocBrowserInformationControlInput getNext() {
		return fNext;
	}
