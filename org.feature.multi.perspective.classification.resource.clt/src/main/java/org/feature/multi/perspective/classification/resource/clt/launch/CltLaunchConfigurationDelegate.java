 ...
 */
public class CltLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.feature.multi.perspective.classification.resource.clt.launch.CltLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
