...
public class ClusterAdapterFactory extends AdapterFactoryImpl {
    ...
    */
	...
	/**
    * Creates a new adapter for an object of class '{@link org.feature.cluster.model.cluster.CoreGroup <em>Core Group</em>}'.
    * <!-- begin-user-doc -->
    ...
    */
	...
	/**
    * Creates a new adapter for an object of class '{@link org.feature.cluster.model.cluster.Group <em>Group</em>}'.
    * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
    ...
    */
	...
	/**
    * Creates a new adapter for an object of class '{@link org.feature.cluster.model.cluster.ViewPoint <em>View Point</em>}'.
    * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
    ...
    */
	...
	/**
    * Creates a new adapter for an object of class '{@link org.feature.cluster.model.cluster.Element <em>Element</em>}'.
    * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
