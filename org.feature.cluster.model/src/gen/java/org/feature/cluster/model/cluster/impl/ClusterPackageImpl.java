...
public class ClusterPackageImpl extends EPackageImpl implements ClusterPackage {
	 ...
	 * @generated
	 */
	public EReference getGroupModel_ViewPoints() {
	 ...
	 * @generated
	 */
	public EReference getIViewPointContainer_ViewPoints() {
		return (EReference)iViewPointContainerEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(groupModelEClass, GROUP_MODEL__VIEW_POINTS);

		iViewPointContainerEClass = createEClass(IVIEW_POINT_CONTAINER);
		createEReference(iViewPointContainerEClass, IVIEW_POINT_CONTAINER__VIEW_POINTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getIGroupContainer_Groups(), this.getGroup(), null, "groups", null, 0, -1, IGroupContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(groupModelEClass, GroupModel.class, "GroupModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGroupModel_CoreGroup(), this.getCoreGroup(), null, "coreGroup", null, 0, 1, GroupModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGroupModel_ViewPoints(), this.getViewPointContainer(), null, "viewPoints", null, 0, 1, GroupModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIViewPointContainer_ViewPoints(), this.getViewPoint(), null, "viewPoints", null, 0, -1, IViewPointContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
