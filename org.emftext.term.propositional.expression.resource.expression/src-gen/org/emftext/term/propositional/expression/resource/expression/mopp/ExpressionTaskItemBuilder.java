 ...
 * detect task items.
 */
public class ExpressionTaskItemBuilder extends org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionBuilderAdapter {
	
	/**
	 * The ID of the item task builder.
	 */
	public final static String BUILDER_ID = "org.emftext.term.propositional.expression.resource.expression.taskItemBuilder";
